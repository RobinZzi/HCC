setwd("~/projects/hcc/analysis/sh_cell_line/wgbs_20240705/bismark_cov/dmr_fdr0.05dmls")
library(Rcircos)

install.packages("RCircos")
rm(list = ls())

dmr_sig <- fread("GA45_dmrs_sig.bedGraph")
...
test_fisher_data <- matrix(c(430,908,194,506),nrow=2)
