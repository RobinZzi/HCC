...
setwd("/storage/zhangyanxiaoLab/zhangliwen/projects/hcc/analysis/sh_cell_line/wgbs/cpg_report")
fs <- list.files()
for (i in 1:length(fs)) {
  ...
  sample_id <-str_split_fixed(fs[i],"_R1_bismark_bt2_pe.deduplicated.CpG_report.txt",2)[1]
