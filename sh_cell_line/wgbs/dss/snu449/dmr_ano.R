...
sig_pmd_p_fisher_data <- matrix(c(74, 191, 72, 239), nrow = 2)
...
#p-value = 0.2117 odds ratio 1.28549  
#X-squared = 1.4799, df = 1, p-value = 0.2238


sig_pmd_h_fisher_data <- matrix(c(104,161 , 121, 190), nrow = 2)
