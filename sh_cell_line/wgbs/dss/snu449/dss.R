...
library(stringr)
library(ggplot2)
setwd("~/projects/hcc/analysis/sh_cell_line/wgbs/dss/SNU449")
rm(list = ls())


save.image("GA45_kd_SNU449_dss.Rdata")

setwd("~/projects/hcc/analysis/sh_cell_line/wgbs/dss/SNU449/bismark_cov")
GA45_c1 <- fread("SNU449-shNull-1.bismark.cov.gz")
GA45_c2 <- fread("SNU449-shNull-2.bismark.cov.gz")
GA45_c3 <- fread("SNU449-shNull-3.bismark.cov.gz")
GA45_e1 <- fread("SNU449-shGADD45A-1.bismark.cov.gz")
GA45_e2 <- fread("SNU449-shGADD45A-2.bismark.cov.gz")
GA45_e3 <- fread("SNU449-shGADD45A-3.bismark.cov.gz")
