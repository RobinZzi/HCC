...
setwd("/storage/zhangyanxiaoLab/zhangliwen/projects/hcc/analysis/sh_cell_line/wgbs_20240705/cpg_report")
...
if(T){
  for (i in 1:length(fs)) {
    ...
    setwd("/storage/zhangyanxiaoLab/zhangliwen/projects/hcc/analysis/sh_cell_line/wgbs_20240705/methy_mtx/10kbin")
