#!/bin/bash  
cd /mnt/transposon1/zhangyanxiaoLab/zhangliwen/hcc_multiomics_gsa_upload/data/scPBAT/HCC8_scPBAT/PT4
...
for file in *.clean.fq.gz; do  
    ...
    new_filename="HCC8_PT${pt_number#pt}_D${d_number#D}_SCPBAT_R${read_number}.fq.gz"  
