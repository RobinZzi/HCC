...
colnames(ga_global_pmd_count) <- c("id","hm","length","rg")
...
colnames(ga_global_hmd_count) <- c("id","hm","length","rg")
...
colnames(ga_dmr_pmd_count) <- c("id","hm","length","rg")
...
colnames(ga_dmr_hmd_count) <- c("id","hm","length","rg")
...
colnames(ga_admr_pmd_count) <- c("id","hm","length","rg")
...
colnames(ga_admr_hmd_count) <- c("id","hm","length","rg")
...
colnames(ga_md_combine) <- c("region","hm","length","region_type")
