...
bedtools intersect -a g6_admr_regions.bedGraph -b PMD_coordinates_hg38.bed  -wo > g6_admr_PMD.bedGraph
bedtools intersect -a g6_dmr_regions.bedGraph -b PMD_coordinates_hg38.bed  -wo > g6_dmr_PMD.bedGraph
bedtools intersect -a g6_global_regions.bedGraph -b PMD_coordinates_hg38.bed  -wo > g6_global_PMD.bedGraph