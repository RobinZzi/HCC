...
library(stringr)
library(ggplot2)
setwd("~/projects/hcc/analysis/oe/dss")
rm(list = ls())

load("dss.Rdata")
save.image("GA45SNG6_oe_dss.Rdata")

setwd("~/projects/hcc/analysis/oe/dss/bismark_cov")
GA45_c1 <- fread("GADD45A-C1.bismark.cov.gz")
GA45_c2 <- fread("GADD45A-C2.bismark.cov.gz")
GA45_c3 <- fread("GADD45A-C3.bismark.cov.gz")
GA45_e1 <- fread("GADD45A-OE1.bismark.cov.gz")
GA45_e2 <- fread("GADD45A-OE2.bismark.cov.gz")
GA45_e3 <- fread("GADD45A-OE3.bismark.cov.gz")
...
showOneDMR(GA45_dmrs['1477',], GA45_BSobj)
